      ...
      {dashboardData ? (
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <DashboardCard title="Total Sales" value={`${dashboardData.totalSales.toFixed(2)}`} />
            <DashboardCard title="Orders Today" value={dashboardData.ordersToday} />
            <DashboardCard title="Low Stock Items" value={dashboardData.lowStockItems} />
            <DashboardCard title="Active Employees" value={dashboardData.activeEmployees} />
          </div>
        </div>
      ) : (
